              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-6 col-sm-12">
                    <p>
                      mpartial, a 40 Schematics Company. Copyright 2020 rights reserved. 
                    </p>
                  </div>
                  <div className="col-md-6 col-sm-12">
                    <ul className="social-links">
                      ...
                      <li>
                        <a target="_blank" href="https://www.instagram.com/mpartial_/" aria-label="Instagram" rel="noopener">
                      ...
                      <li>
                        <a target="_blank" href="https://www.linkedin.com/company/mpartial-keep-building" aria-label="Linkedin" rel="noopener">
